...
def get_main():
    ...
    framework, work_type = 'smolagents', 'RAG'
    ...
    task_lists = {
        "smolagents":
        {
            "DuckDuckGo": "Search for luxury superhero-themed party ideas, including decorations, entertainment, and catering.",
            "Custom_KB": "Find ideas for a luxury superhero-themed party, including entertainment, catering, and decoration options.",
        }
    }
